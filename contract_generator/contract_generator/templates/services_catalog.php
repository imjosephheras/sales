...
$servicesCatalog = [
    ...
    "Hood Cleaning (Basic)" => [
        ...
        "This service is performed in accordance with the applicable standard, including NFPA 96, and in compliance with the requirements and guidelines established by that standard."
    ],
    ...
    "Grease Trap Cleaning Emergency Call-Out" => [
    ...
    "Grease Trap Cleaning Waste Removal" => [
    ...
    "High Dusting of Ceilings (Basic)" => [
    ...
    "High Dusting of Ceilings (Detailed)" => [
    ...
    "Commercial Duct Cleaning (Detailed)" => [
